    ...
    public class AspNetIdentiyAuthorizeRelay<TUser> where TUser : SysUser
    {
        ...
        public bool CreateUser(TUser user, params int[] roleIds)
        {
            ...
            if (result.Succeeded)
            {
                ...
                AddOperateHistory(Enumeration.OperateType.New, user.Id, string.Format("新建用户{0}(ID:{1})", user.UserName, user.Id));
            }
        ...
        public bool UpdateUser(TUser user, string password, params int[] roleIds)
        {
            ...
            if (result.Succeeded)
            {
                ...
                AddOperateHistory(Enumeration.OperateType.Update, user.Id, string.Format("修改用户{0}(ID:{1})", user.UserName, user.Id));
        ...
        public bool DeleteUser(int operater, int[] userIds)
        {
            ...
            foreach (int userId in userIds)
            {
                ...
                AddOperateHistory(Enumeration.OperateType.Delete, user.Id, string.Format("删除用户{0}(ID:{1})", user.UserName, user.Id));
            }
        ...
        public bool CreateRole(int operater, SysRole role)
        {
            ...
            AddOperateHistory(Enumeration.OperateType.New, role.Id, string.Format("新建角色{0}(ID:{1})", role.Name, role.Id));
        ...
        public void DeleteRole(int operater, int[] ids)
        {
            ...
            if (ids != null)
            {
                foreach (var id in ids)
                {
                    ...
                    AddOperateHistory(Enumeration.OperateType.Delete, role.Id, string.Format("删除角色{0}(ID:{1})", role.Name, role.Id));
                }
        ...
        public bool UpdateRole(int operater, SysRole sysRole)
        {
            ...
            if (_sysRole != null)
            {
                ...
                AddOperateHistory(Enumeration.OperateType.Update, _sysRole.Id, string.Format("修改角色{0}(ID:{1})", _sysRole.Name, _sysRole.Id));
        ...
        public bool AddUserToRole(int operater, int userId, int roleId)
        {
            ...
            AddOperateHistory(Enumeration.OperateType.Update, roleId, string.Format("添加用户(ID：{0})到角色(ID:{1})", userId, roleId));
        ...
        public void RemoveUserFromRole(int operater, int roleId, int userId)
        {
            ...
            AddOperateHistory(Enumeration.OperateType.Update, roleId, string.Format("移除用户(ID：{0})所在的角色(ID:{1})", userId, roleId));
        ...
        public bool SaveRoleMenu(int operater, int roleId, int[] menuIds)
        {
            ...
            AddOperateHistory(Enumeration.OperateType.Update, roleId, string.Format("保存角色(ID:{0})菜单", roleId));
        ...
        public int CreateMenu(int operater, SysMenu sysMenu, string[] perssionId)
        {
            ...
            AddOperateHistory(Enumeration.OperateType.New, sysMenu.Id, string.Format("新建菜单(ID:{0})", sysMenu.Id));
        ...
        public void DeleteMenu(int operater, int[] ids)
        {
            if (ids != null)
            {
                foreach (var id in ids)
                {
                    ...
                    AddOperateHistory(Enumeration.OperateType.Delete, id, string.Format("删除菜单(ID:{0})", id));
