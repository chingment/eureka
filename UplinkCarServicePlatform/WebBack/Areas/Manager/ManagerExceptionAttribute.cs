...
using WebBack.Areas.Manager.Models;
using Lumos.Mvc;
...
namespace WebBack.Areas.Manager
{
    ...
    public class ManagerExceptionAttribute : FilterAttribute, IExceptionFilter
    {
        ...
        void IExceptionFilter.OnException(ExceptionContext filterContext)
        {
            ...
            messageBox.Content = "<a href=\"javascript:void(0)\" onclick=\"window.top.location.href='" + ManagerConfig.GetHomePage() + "'\">返回主页</a>";
            messageBox.IsTop = true;
            if (ManagerConfig.CanViewErrorStackTrace())
            {
