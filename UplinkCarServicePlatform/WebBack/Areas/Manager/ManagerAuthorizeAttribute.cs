    ...
    public class ManagerAuthorizeAttribute : AuthorizeAttribute
    {
        ...
        public override void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            if (Permissions != null)
            {
                ...
                {
                    messageBox.Content = "请重新<a href=\"javascript:void(0)\" onclick=\"window.top.location.href='" + ManagerConfig.GetLoginPage() + "'\">登录</a>后打开";
                }
        ...
        protected override void HandleUnauthorizedRequest(AuthorizationContext filterContext)
        {
            ...
            filterContext.Result = new RedirectResult(ManagerConfig.GetLoginPage());
