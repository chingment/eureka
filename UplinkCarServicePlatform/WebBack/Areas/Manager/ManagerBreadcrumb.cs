...
namespace WebBack.Areas.Manager
{
    ...
    {
        public static readonly string WebName = ManagerConfig.GetWebName();
        public static readonly string HomeTite = ManagerConfig.GetHomeTitle();
        public static readonly string HomePage = ManagerConfig.GetHomePage();
        public static IHtmlString Render(SiteMapNode currNode)
        {
            ...
            {
                sb.Append("<li><a href=\"" + ManagerBreadcrumb.HomePage + "\" class=\"root\"> &nbsp; </a></li>");
        ...
        public static string GetTitle()
        {
            ...
            else
            {
                ...
                {
                    string title = parent.Title;
                    if (title == ManagerBreadcrumb.HomeTite)
                    {
                        title = WebName;
                    }
                    tiltes.Add(title);
