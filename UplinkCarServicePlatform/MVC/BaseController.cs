...
namespace Lumos.Mvc
{
    public abstract class BaseController : Controller
    {
        ...
        {
            return Json(null, type, null, message, content, null, converters);
        }

        protected JsonResult Json(ResultType type, object content, string message, JsonSerializerSettings settings)
        {
            return Json(null, type, null, message, content, settings);
        }
        ...
        {
            return Json(contenttype, type, null, message, content, null);
        }

        protected JsonResult Json(string contenttype, ResultType type, string code, string message, object content, JsonSerializerSettings settings, params JsonConverter[] converters)
        {
